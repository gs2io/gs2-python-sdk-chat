...
class SearchLogByAllRoomRequest(Gs2BasicRequest):

    class Constant(Gs2Chat):
        FUNCTION = "SearchLogByAllRoom"
    ...
    def __init__(self, params=None):
        ...
        """
        super(SearchLogByAllRoomRequest, self).__init__(params)
        if params is None:
        ...
        if params is None:
            self.__use_cache = None
        else:
            self.set_use_cache(params['useCache'] if 'useCache' in params.keys() else None)
    ...
    def with_lobby_name(self, lobby_name):
        ...
        :type lobby_name: unicode
        :return: this
        :rtype: SearchLogByAllRoomRequest
        """
